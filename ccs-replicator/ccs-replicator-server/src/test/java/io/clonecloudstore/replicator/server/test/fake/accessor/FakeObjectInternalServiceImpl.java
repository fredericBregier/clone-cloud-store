...
@Path(INTERNAL_ROOT)
public class FakeObjectInternalServiceImpl extends FakeObjectPrivateServiceAbstract<FakePrivateStreamHandlerImpl> {
  private static final Logger logger = Logger.getLogger(FakeObjectInternalServiceImpl.class);
