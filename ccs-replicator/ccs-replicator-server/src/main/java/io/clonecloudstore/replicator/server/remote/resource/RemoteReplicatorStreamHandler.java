...
@RequestScoped
public class RemoteReplicatorStreamHandler extends StreamHandlerAbstract<ReplicatorOrder, AccessorObject> {
  private static final Logger LOGGER = Logger.getLogger(RemoteReplicatorStreamHandler.class);
