...
@RequestScoped
public class LocalReplicatorStreamHandler extends StreamHandlerAbstract<ReplicatorOrder, AccessorObject> {
  private static final Logger LOGGER = Logger.getLogger(LocalReplicatorStreamHandler.class);
