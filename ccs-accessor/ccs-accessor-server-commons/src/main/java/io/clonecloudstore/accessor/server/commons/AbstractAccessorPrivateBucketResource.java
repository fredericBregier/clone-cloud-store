...
public abstract class AbstractAccessorPrivateBucketResource extends AbstractPrivateBucketHelper
    implements AccessorBucketInternalApi {
  //TODO : Security check and get Client ID
  protected AbstractAccessorPrivateBucketResource(final AccessorBucketServiceInterface service) {
    super(service);
  }
}
