...
public class FakeLocalReplicatorObjectServiceImpl
    extends FakeObjectServiceAbstract<FakeNativeLocalReplicatorStreamHandlerImpl> {
  private static final Logger logger = Logger.getLogger(FakeLocalReplicatorObjectServiceImpl.class);
  ...
  protected void remoteDeleteObject(final AccessorObject accessorObject, final String clientId) {
    logger.infof("Delete %s", accessorObject);
    // Empty
  }
