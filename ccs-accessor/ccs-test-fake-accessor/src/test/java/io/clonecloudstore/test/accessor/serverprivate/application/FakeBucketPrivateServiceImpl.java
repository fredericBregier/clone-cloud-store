...
@Path(INTERNAL_ROOT)
public class FakeBucketPrivateServiceImpl extends FakeBucketPrivateServiceAbstract {
  private static final Logger logger = Logger.getLogger(FakeBucketPrivateServiceImpl.class);
