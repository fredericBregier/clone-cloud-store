 ...
 */
public class AccessorBucketInternalApiClient extends SimpleClientAbstract<AccessorBucketInternalApi> {
  /**
   * Constructor used by the Factory
   */
  protected AccessorBucketInternalApiClient(final AccessorBucketInternalApiFactory factory) {
  ...
  /**
   * @param fullCheck if True, check also on Object Storage
   * @return the StorageType for this Bucket
   */
  public StorageType checkBucket(final String bucketName, final String clientId, final boolean fullCheck)
      throws CcsWithStatusException {
    final var uni = getService().checkBucket(bucketName, fullCheck, clientId, getOpId());
