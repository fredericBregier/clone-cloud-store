...
@RequestScoped
public class ServerStreamHandler extends StreamHandlerAbstract<ApiBusinessIn, ApiBusinessOut> {
  private static final Logger LOG = Logger.getLogger(ServerStreamHandler.class);
  private final ApiQuarkusClientFactory factory;

  protected ServerStreamHandler(final ApiQuarkusClientFactory factory) {
    // CDI
