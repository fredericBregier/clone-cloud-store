 ...
 * Operation exception
 */
public class CcsOperationException extends CcsServerGenericException {
   ...
   */
  public CcsOperationException(final String message) {
   ...
   */
  public CcsOperationException(final Throwable cause) {
   ...
   * @param cause   Initial Exception
   */
  public CcsOperationException(final String message, final Throwable cause) {
