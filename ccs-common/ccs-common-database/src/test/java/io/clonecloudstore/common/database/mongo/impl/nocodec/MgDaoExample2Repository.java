...
@ApplicationScoped
public class MgDaoExample2Repository extends ExtendedPanacheMongoRepositoryBase<DaoExample2, MgDaoExample2>
    implements DaoExample2Repository {
  @Override
  ...
  @Override
  public DaoExample2 createEmptyItem() {
    return new MgDaoExample2();
  }
   ...
   */
  public DaoExample2 findUsingStream(final DbQuery dbQuery) throws CcsDbException {
