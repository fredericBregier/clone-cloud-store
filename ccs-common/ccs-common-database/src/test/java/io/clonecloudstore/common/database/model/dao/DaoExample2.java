...
@MappedSuperclass
public abstract class DaoExample2 {
  // No Id nor BsonId
  ...
  public DaoExample2 setField1(final String field1) {
  ...
  public DaoExample2 setField2(final String field2) {
  ...
  public DaoExample2 setTimeField(final Instant timeField) {
  ...
  public abstract DaoExample2 setGuid(String guid);
}
