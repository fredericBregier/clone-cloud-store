...
public interface DaoExampleRepository extends RepositoryBaseInterface<DaoExample> {
  String TABLE_NAME = "dto_example";
  String FIELD1 = "field1";
  String FIELD2 = "field2";
  String TIME_FIELD = "timeField";

  DaoExample findUsingStream(final DbQuery dbQuery) throws CcsDbException;
}
