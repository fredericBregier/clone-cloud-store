...
public class MinioMongoKafkaProfile extends CommonProfile {
  @Override
  public String getConfigProfile() {
    return "test-minio-mongo-kafka";
  }

  @Override
  public List<TestResourceEntry> testResources() {
    return List.of(new TestResourceEntry(MinIoResource.class, Collections.emptyMap(), true),
