...
public class AzureMongoKafkaProfile extends CommonProfile {
  @Override
  public String getConfigProfile() {
    return "test-azure-mongo-kafka";
  }

  @Override
  public List<TestResourceEntry> testResources() {
    return List.of(new TestResourceEntry(AzureResource.class, Collections.emptyMap(), true),
        new TestResourceEntry(MongoDbResource.class, Collections.emptyMap(), true),
