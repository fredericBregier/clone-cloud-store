...
package io.clonecloudstore.driver.google.example.server;
...
import io.clonecloudstore.driver.google.example.client.ApiConstants;
import io.vertx.core.MultiMap;
import jakarta.enterprise.context.RequestScoped;
import org.jboss.logging.Logger;

import static io.clonecloudstore.driver.google.example.server.ApiService.NOT_ACCEPTABLE_NAME;

@RequestScoped
public class NativeStreamHandler extends NativeStreamHandlerAbstract<StorageObject, StorageObject> {
  private static final Logger LOG = Logger.getLogger(NativeStreamHandler.class);
