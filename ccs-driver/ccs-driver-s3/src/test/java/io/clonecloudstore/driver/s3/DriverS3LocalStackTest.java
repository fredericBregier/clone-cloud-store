...
public class DriverS3LocalStackTest extends DriverS3Base {
  ...
  static void setup() throws InterruptedException {
    ...
    DriverS3Properties.setDynamicS3Parameters(LocalStackResource.getUrlString(), LocalStackResource.getAccessKey(),
        LocalStackResource.getSecretKey(), LocalStackResource.getRegion());
