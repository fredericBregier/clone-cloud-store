...
@ApplicationScoped
@Unremovable
public class DriverAzureApiFactory implements DriverApiFactory {
  private final DriverAzureHelper driverAzureHelper;

  public DriverAzureApiFactory(DriverAzureHelper driverAzureHelper) {
    this.driverAzureHelper = driverAzureHelper;
  }

  @Override
  public DriverApi getInstance() throws DriverRuntimeException {
    return new DriverAzure(driverAzureHelper);
  }
}
