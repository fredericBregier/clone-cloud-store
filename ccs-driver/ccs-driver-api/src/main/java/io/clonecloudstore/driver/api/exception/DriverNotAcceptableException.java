...
public class DriverNotAcceptableException extends DriverException {
  public DriverNotAcceptableException(final String message) {
    super(message);
  }

  public DriverNotAcceptableException(final String message, final Throwable cause) {
    super(message, cause);
  }

  public DriverNotAcceptableException(final Throwable cause) {
