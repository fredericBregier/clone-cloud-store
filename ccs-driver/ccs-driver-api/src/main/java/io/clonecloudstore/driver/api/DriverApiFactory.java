...
public interface DriverApiFactory {
  ...
  /**
   * @return the unique DriverApi associated with this Factory
   * @throws DriverRuntimeException if the client initialisation is in error
   */
  DriverApi getInstance() throws DriverRuntimeException;
}
