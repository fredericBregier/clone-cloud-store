...
public abstract class DaoRequest {
  ...
  String currentSite;
  @Column(name = DaoRequestRepository.CONTEXTSITES)
  List<String> contextSites;
  /*
   * Not taken into account in equals, hash or Dto
   */
  @Column(name = DaoRequestRepository.CONTEXTSITESDONE)
  List<String> contextSitesDone;
  ...
  public List<String> getContextSites() {
    return contextSites;
  }

  public DaoRequest setContextSites(final List<String> contextSites) {
    this.contextSites = contextSites;
    return this;
  }

  public List<String> getContextSitesDone() {
    return contextSitesDone;
  }

  public DaoRequest setContextSitesDone(final List<String> contextSitesDone) {
    this.contextSitesDone = contextSitesDone;
    return this;
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (obj instanceof DaoRequest that) {
      return Objects.equals(getId(), that.getId()) && Objects.equals(getClientId(), that.getClientId()) &&
          ...
          Objects.equals(getCurrentSite(), that.getCurrentSite()) &&
          Objects.equals(getContextSites(), that.getContextSites()) && Objects.equals(getStart(), that.getStart()) &&
