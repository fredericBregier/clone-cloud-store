...
public interface DaoNativeListingRepository extends RepositoryBaseInterface<DaoNativeListing> {
  String TABLE_NAME = "nativelisting";
   ...
   */
  void saveNativeListingDb(final DaoRequest daoRequest) throws CcsDbException;

  void saveNativeListingDriver(final DaoRequest daoRequest) throws CcsDbException;

  void compareNativeListingDbDriver(final DaoRequest daoRequest) throws CcsDbException;

  void cleanNativeListing(final DaoRequest daoRequest) throws CcsDbException;
}
