...
public interface DaoSitesActionRepository extends RepositoryBaseInterface<DaoSitesAction> {
  ...
  void saveFromSitesListing(final DaoRequest daoRequest) throws CcsDbException;

  Iterator<DaoSitesAction> getSitesActon(final DaoRequest daoRequest) throws CcsDbException;

  void cleanSitesAction(final DaoRequest daoRequest) throws CcsDbException;
}
