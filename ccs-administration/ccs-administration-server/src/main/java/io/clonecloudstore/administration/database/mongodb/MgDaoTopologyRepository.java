...
import io.clonecloudstore.administration.database.model.DaoTopology;
...
@ApplicationScoped
public class MgDaoTopologyRepository extends ExtendedPanacheMongoRepositoryBase<DaoTopology, MgDaoTopology>
  ...
  @Override
  public DaoTopology createEmptyItem() {
    return new MgDaoTopology();
  }

  public void createIndex() throws CcsDbException {
    try {
      mongoCollection().createIndex(Indexes.ascending(ID, NAME, STATUS),
