...
@ApplicationScoped
public class MgDaoOwnershipRepository extends ExtendedPanacheMongoRepositoryBase<DaoOwnership, MgDaoOwnership>
  ...
  @Override
  public DaoOwnership createEmptyItem() {
    return new MgDaoOwnership();
  }

  public void createIndex() throws CcsDbException {
    try {
      mongoCollection().createIndex(Indexes.ascending(CLIENT_ID, OWNERSHIP),
